    ...
    <section id="about">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="flex bg-gray-100 p-10">
            <div className="mb-auto mt-auto max-w-lg">
              ...
              <NavLink to="/contact" className="inline-block bg-gray-900 hover:bg-gray-800 rounded-md py-3 px-7 mt-6 text-white">Email Me</NavLink>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-200 h-full w-full px-5 pt-6 pb-20">
        <div className="container m-auto max-w-screen-xl">
            ...
            <div className="mb-5">
                <NavLink to="/magento-2-frontend-developer" className="block relative rounded-lg relative p-5 transform transition-all duration-300 scale-100 hover:scale-95 bg-cover bg-center bg-no-repeat" 
            ...
            <div className="flex -mx-1 mb-5">
                <div className="w-1/2 px-1">
                    <NavLink to="/what-is-a-front-end-developer" className="block mb-2 p-5 rounded overflow-hidden transform transition-all duration-300 scale-100 hover:scale-95 bg-cover bg-center bg-no-repeat"
                        style={{backgroundImage: "url("+ FeDev +")"}}>
                        <div className="h-24"></div>
                        <h3 className="text-lg font-bold text-white leading-tight">What is a front-end developer and how to think like one?</h3>
                    </NavLink>
                    <NavLink to="#" className="block mb-2 p-5 rounded overflow-hidden transform transition-all duration-300 scale-100 hover:scale-95 bg-cover bg-center bg-no-repeat" 
                        ...
                        <h3 className="text-lg font-bold text-white leading-tight">Top Travels Destinations For 2020</h3>
                    </NavLink>
                </div>
                <div className="w-1/2 px-1">
                    <NavLink to="#" className="block mb-2 p-5 rounded overflow-hidden transform transition-all duration-300 scale-100 hover:scale-95 bg-cover bg-center bg-no-repeat" 
                        ...
                        <div className="h-32"></div>
                        <h3 className="text-lg font-bold text-white leading-tight">M&S Launches New Makeup Range!</h3>
                    </NavLink>
                    <NavLink to="#" className="block mb-2 p-5 rounded overflow-hidden transform transition-all duration-300 scale-100 hover:scale-95 bg-cover bg-center bg-no-repeat" 
                        ...
                        <div className="h-24"></div>
                        <h3 className="text-lg font-bold text-white leading-tight">APT Set To Be A&nbsp;Ripper</h3>
                    </NavLink>
                </div>
            </div>
          </div>
